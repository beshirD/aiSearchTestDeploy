      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'results_count',
              isInvalid: !!formik.errors?.results_count,
            }}
            name="results_count"
            error={formik.errors?.results_count}
            value={formik.values?.results_count}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('results_count', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
